...
{
    private String TAG = "DOWNLOAD_SERVICE";
    private static String TAG2 = "DOWNLOAD_SERVICE_2";
    ...
    public static String getPathname(Message message) {
        Log.d(TAG2, "getPathname Entered");
    ...
    private final class ServiceHandler extends Handler {
        private String TAG = "SERVICE_HANDLER";
    	...
    	public ServiceHandler(Looper looper) {
            ...
            Log.d(TAG, "ServiceHandler Entered");
    	}
        ...
        private Message makeDownloadMessage(Intent intent,
                                            int startId){
            Log.d(TAG, "makeDownloadMessage Entered");
        ...
        private void downloadImageAndReply(Intent intent) {
            Log.d(TAG, "downloadImageAndReply Entered");
        ...
        private Message makeReplyMessage(String pathname){
            Log.d(TAG, "makeReplyMessage Entered");
	...
	private File getTemporaryFile(final Context context,
        ...
        Log.d(TAG, "getTemporaryFile Entered");
